                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">Password</label> <input
                            ...
                            id="exampleInputPassword1" placeholder="Password" minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password must contain at least one uppercase letter, one lowercase letter, and one number, and must be at least 8 characters long">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" id="form-control" cols="55" rows="5"
